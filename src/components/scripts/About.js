		...
		<div className="about-container">
			...
			<div className="about-sai">
				...
				<p className="about-text">
					...
					<a href="https://manikanta-portfolio.netlify.app" target="_blank" rel="noopener noreferrer">
						here
					</a>
					.
				</p>
			...
			<p className="about-text">
				If you have any questions, comments, or suggestions, please feel free to contact us at <a href="mailto:manifreelancer25@gmail.com">manifreelancer25@gmail.com</a>. We would love to hear from you and are always looking for ways to improve our website.
			</p>
			<p className="about-text" style={{ color: "rgb(223, 35, 110)" }}>
				Thank you for visiting Recipes Collection and happy cooking!
			</p>
		</div>
	);
}
